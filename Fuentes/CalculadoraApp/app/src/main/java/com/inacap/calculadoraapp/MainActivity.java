package com.inacap.calculadoraapp;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Aqui puedo acceder a los elementos de la interfez, referente del View que tiene el id n1_txt
    ...
    public void restar(View v){
        ...
        try{
            ...
            Toast.makeText(this, "La resta es "+ resta, Toast.LENGTH_SHORT).show();
        }catch (Exception ex){
            Toast.makeText(this, "Error", Toast.LENGTH_SHORT).show();
        }
    }
